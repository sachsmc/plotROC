...
**plotROC** can currently only be installed from github. It also requires the development version of **ggplot2**.
...
plotROC uses the `ggplot2` package to create the objects to be plotted. Therefore, themes and annotations can be added in the usual ggplot2 way, or with external libraries such as `ggthemes`. 
